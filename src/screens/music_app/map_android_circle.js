...
class MapAndroidCircle extends Component  {
  constructor(props) {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.topContainer}>
          ...
          >
            {this.state.markers.map((marker, idx) => (
              ...
              <MapView.Circle
                key = { (this.state.region.latitude + this.state.region.longitude).toString() }
        ...
        <View style={styles.bottomContainer}>
          ...
          <Button block onPress={this.handleCenter}>
...
export default MapAndroidCircle;